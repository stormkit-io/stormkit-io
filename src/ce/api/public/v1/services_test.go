...
func (s *ServicesSuite) Test_EE() {
	...
	statusMap := map[string]int{
		...
		"GET:/v1/auth/verify":                      http.StatusBadRequest,
		"POST:/v1/auth/register":                   http.StatusBadRequest,
		"POST:/v1/auth/login":                      http.StatusBadRequest,
		"GET:/v1/auth/users":                       http.StatusForbidden,
